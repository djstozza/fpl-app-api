module Api::FplTeamLists
  class InterTeamTradeGroups::ApprovesController < InterTeamTradeGroupsController
    load_resource :fpl_team_list
    load_resource :inter_team_trade_group

    def create
      service = ::InterTeamTradeGroups::Approve.call(inter_team_trade_group, current_user)
