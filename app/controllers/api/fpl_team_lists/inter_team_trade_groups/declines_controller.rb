module Api::FplTeamLists
  class InterTeamTradeGroups::DeclinesController < InterTeamTradeGroupsController
    load_resource :fpl_team_list
    load_resource :inter_team_trade_group

    def create
      service = ::InterTeamTradeGroups::Decline.call(inter_team_trade_group, current_user)
